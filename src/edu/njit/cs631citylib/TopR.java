...
public class TopR extends JDialog{
	...
	public TopR() {
		...
		String[] columnNames = {"READER","No. of Books"};
		ArrayList<ArrayList<Object>> result = new ArrayList<ArrayList<Object>>();
		
		result = m.execQuery("SELECT `READERID`, COUNT(*) FROM `BORROWS` GROUP BY READERID ORDER BY COUNT(*) DESC LIMIT 10;");
