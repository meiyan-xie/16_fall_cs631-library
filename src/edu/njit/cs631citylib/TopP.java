...
public class TopP extends JDialog{
	...
	public TopP() {
		...
		result = m.execQuery("SELECT `DOCID`, COUNT(*) FROM `BORROWS` WHERE YEAR(BDTIME) = 2016 GROUP BY DOCID ORDER BY COUNT(*) DESC LIMIT 10;");
